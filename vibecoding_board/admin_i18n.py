...
_MESSAGES: dict[AdminLocale, dict[str, str]] = {
    "en": {
        ...
        "updated_responses_websocket_settings": "Updated Responses websocket settings.",
        "promoted_provider": "Promoted provider {provider}.",
        "toggled_provider": "Toggled provider {provider}.",
        "toggled_provider_always_alive": "Updated always-alive mode for {provider}.",
    ...
    "zh-CN": {
        ...
        "updated_responses_websocket_settings": "已更新 Responses WebSocket 设置。",
        "promoted_provider": "已将 Provider {provider} 提升为主路由。",
        "toggled_provider": "已切换 Provider {provider} 的启用状态。",
        "toggled_provider_always_alive": "已更新 Provider {provider} 的始终存活模式。",
